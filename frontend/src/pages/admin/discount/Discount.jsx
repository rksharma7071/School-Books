    ...
    <div className="max-w-7xl mx-auto space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          />
          <Link to={`/${import.meta.env.VITE_ADMIN}/discounts/add`} className="hidden sm:inline-flex items-center px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700">Add Discount</Link>
        </div>
      </div>
