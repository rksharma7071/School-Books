            ...
            <section className="bg-blue-950 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-blue-100 text-sm sm:text-base leading-relaxed">Find textbooks, study materials and educational resources organized by subject and category.</p>
                    </div>
                </div>
            </section>
                            ...
                            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                                {filteredCategories.map((category) => (
                                    <Link
                                        ...
                                        <h3 className="mt-5 text-lg font-semibold text-gray-900">{category.name}</h3>

                                        {category.description && (
                                            <p className="mt-2 text-sm text-gray-500 line-clamp-2">{category.description}</p>
                                        )}

                                        <div className="mt-5 text-sm font-medium text-blue-600">View Books →</div>
                                    </Link>
                                ))}
                            </div>
                        )}
