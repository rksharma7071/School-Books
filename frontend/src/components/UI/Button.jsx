const Button = ({ children, variant = "primary", disabled = false, className = "", onClick, type = "button" }) => {
    const baseStyles = "w-full rounded-xl py-3 font-semibold transition-all active:scale-95 disabled:cursor-not-allowed disabled:opacity-60";

    const variants = {
        primary: "bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md hover:from-blue-700 hover:to-blue-600 hover:shadow-md",
        secondary: "border border-blue-600 bg-white text-blue-600 hover:bg-blue-600 hover:text-white hover:shadow-md",
