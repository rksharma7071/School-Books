                ...
                <div>
                    ...
                    {openMenu === "books" && (
                        <div className="mt-2 space-y-1 text-sm">
                            <Link
                                to="/books"
                                className="group flex items-center justify-between rounded-lg px-10 py-2 text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors"
                            >
                                <span className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-gray-300 group-hover:bg-indigo-500" />All Books</span>
                                <span className="text-[10px] px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 group-hover:bg-indigo-100 group-hover:text-indigo-700">120</span>
                            </Link>
                            ...
                            >
                                <span className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-gray-300 group-hover:bg-indigo-500" />Add Book</span>
                                <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 group-hover:bg-emerald-100">New</span>
                            </Link>
                            ...
                            >
                                <span className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-gray-300 group-hover:bg-indigo-500" />Categories</span>
                                <span className="text-[10px] px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 group-hover:bg-indigo-100 group-hover:text-indigo-700">8</span>
                            </Link>
                        </div>
                    )}
